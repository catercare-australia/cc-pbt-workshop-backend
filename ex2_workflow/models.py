...
class Order(models.Model):
    ...
    def cancel(self):
        ...
        # BUG: also allows PAID — should only allow DRAFT and SUBMITTED
        if self.status not in (OrderStatus.DRAFT, OrderStatus.SUBMITTED, OrderStatus.PAID):
